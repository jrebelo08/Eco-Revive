...
class ModerateChatsSeeMsgs extends StatefulWidget {
  ...
  @override
  State<ModerateChatsSeeMsgs> createState() => _ChatState();
}

class _ChatState extends State<ModerateChatsSeeMsgs> with WidgetsBindingObserver {
  ...
  Widget buildAllMessages() {
    return StreamBuilder(
        stream: ChatController()
            .getMessages(widget.product.productID, widget.receiverId, widget.senderId),
